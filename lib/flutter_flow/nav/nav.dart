...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'listagemBanners',
          path: '/listagemBanners',
          builder: (context, params) => ListagemBannersWidget(),
        ),
        FFRoute(
          name: 'bannerDetail',
          path: '/bannerDetail',
        ...
        FFRoute(
          name: 'criarBanner',
          path: '/criarBanner',
          builder: (context, params) => CriarBannerWidget(),
        ),
        FFRoute(
          name: 'addBanner',
          path: '/addBanner',
        ...
        FFRoute(
          ...
          builder: (context, params) => ListagemPostagensWidget(
            bannerid: params.getParam('bannerid', ParamType.int),
          ),
        )
